...
namespace Microsoft.Identity.Web
{
    ...
    public static class ClaimsPrincipalExtensions
    {
        ...
        ///     <see cref="Microsoft.Identity.Client.AccountId.Identifier" />
        /// </returns>
        ...
        {
            var userObjectId = claimsPrincipal.FindFirstValue(ClaimConstants.Oid);
        ...
        {
            var tenantId = claimsPrincipal.FindFirstValue(ClaimConstants.Tid);
            if (string.IsNullOrEmpty(tenantId)) tenantId = claimsPrincipal.FindFirstValue(ClaimConstants.TenantId);
            return tenantId;
        }
        ...
        public static string GetDomainHint(this ClaimsPrincipal claimsPrincipal)
        {
            ...
            var domainHint = string.IsNullOrWhiteSpace(tenantId)
                ? null
        ...
        /// <returns>
        ///     A string containing the display name for the user, as brought by Azure AD (v1.0) and Microsoft identity platform
        ///     (v2.0) tokens,
        ///     or <c>null</c> if the claims cannot be found
        /// </returns>
        ...
        public static string GetDisplayName(this ClaimsPrincipal claimsPrincipal)
        {
            ...
            var displayName = claimsPrincipal.FindFirstValue(ClaimConstants.PreferredUserName);
