...
{
    /// <summary>
    ///     Generic class that validates token issuer from the provided Azure AD authority. Use the
    ///     <see cref="AadIssuerValidatorFactory" /> to create instances of this class.
    /// </summary>
    public class AadIssuerValidator
    {
        private const string AzureADIssuerMetadataUrl =
        ...
        private static readonly IDictionary<string, AadIssuerValidator> s_issuerValidators =
            new ConcurrentDictionary<string, AadIssuerValidator>();

        private static readonly ConfigurationManager<IssuerMetadata> s_configManager =
            new ConfigurationManager<IssuerMetadata>(AzureADIssuerMetadataUrl, new IssuerConfigurationRetriever());
        ...
        /// <summary>
        ///     Validate the issuer for multi-tenant applications of various audience (Work and School account, or Work and School
        ///     accounts +
        ///     Personal accounts)
        /// </summary>
        ...
        ///     Authority aliasing is also taken into account
        /// </remarks>
        ...
        public string Validate(string actualIssuer, SecurityToken securityToken,
            TokenValidationParameters validationParameters)
        {
            ...
            if (string.IsNullOrWhiteSpace(tenantId))
                throw new SecurityTokenInvalidIssuerException(
                    "Neither `tid` nor `tenantId` claim is present in the token obtained from Microsoft identity platform.");
            ...
            throw new SecurityTokenInvalidIssuerException(
                $"Issuer: '{actualIssuer}', does not match any of the valid issuers provided for this application.");
        }
