...
namespace Microsoft.Identity.Web
{
    ...
    public static class WebApiServiceCollectionExtensions
    {
            ...
            services.Configure<JwtBearerOptions>(AzureADDefaults.JwtBearerAuthenticationScheme, options =>
            {
                ...
                if (tokenDecryptionCertificate != null)
                    options.TokenValidationParameters.TokenDecryptionKey =
                        new X509SecurityKey(tokenDecryptionCertificate);
        ...
        /// <param name="scopes">
        ///     Optional parameters. If not specified, the token used to call the protected API
        ///     will be kept with the user's claims until the API calls a downstream API. Otherwise the account for the
        ///     user is immediately added to the token cache
        /// </param>
        /// <returns></returns>
