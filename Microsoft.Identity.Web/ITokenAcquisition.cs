...
namespace Microsoft.Identity.Web
{
    ...
    {
        /// <summary>
        ///     In a Web App, adds, to the MSAL.NET cache, the account of the user authenticating to the Web App, when the
        ///     authorization code is received (after the user
        ///     signed-in and consented)
        ///     An On-behalf-of token contained in the <see cref="AuthorizationCodeReceivedContext" /> is added to the cache, so
        ///     that it can then be used to acquire another token on-behalf-of the
        ...
        /// </code>
        /// </example>
        Task AddAccountToCacheFromAuthorizationCodeAsync(AuthorizationCodeReceivedContext context,
