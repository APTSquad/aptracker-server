...
namespace Microsoft.Identity.Web.InstanceDiscovery
{
    ...
    internal class IssuerConfigurationRetriever : IConfigurationRetriever<IssuerMetadata>
    {
        ...
        ///     <see cref="T:Microsoft.IdentityModel.Protocols.IDocumentRetriever" />.
        /// </summary>
        /// <param name="address">Address of the discovery document.</param>
        /// <param name="retriever">
        ///     The <see cref="T:Microsoft.IdentityModel.Protocols.IDocumentRetriever" /> to use to read the
        ///     discovery document.
        /// </param>
        /// <param name="cancel">
        ///     A cancellation token that can be used by other objects or threads to receive notice of
        ///     cancellation. <see cref="T:System.Threading.CancellationToken" />.
        /// </param>
        /// <returns></returns>
        /// <exception cref="ArgumentNullException">
        ///     address - Azure AD Issuer metadata address url is required
        ///     or
        ///     retriever - No metadata document retriever is provided
        /// </exception>
        public async Task<IssuerMetadata> GetConfigurationAsync(string address, IDocumentRetriever retriever,
